...
console.log(
  `tu primer poder es ${elBoss.poderes[0].nombre} y hace ${elBoss.poderes[0].description}`
);
...
console.log(
  `tu tercer poder es ${elBoss.poderes[2].nombre} y hace ${elBoss.poderes[2].description}`
);
...
console.log(
  `conozco a tu ${elBoss.familiares[3].parentesco} ${elBoss.familiares[3].nombre}`
);
...
console.log(totalEdades/familiares.length);
